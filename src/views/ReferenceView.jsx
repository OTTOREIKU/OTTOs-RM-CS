...
const FORMULA_SECTIONS = [
  ...
  },
  {
    ...
    note: 'Your RR total is compared to the caster\'s Spellcasting Roll (SCR) — beat it to fully resist. The "−2 × attacker level" term is applied at roll time. (CoreLaw Table 5-6; SpellLaw Section 4.5)',
  },
  {
    key: 'spellcasting',
    title: 'Spell Casting Roll (SCR)',
    color: '#a855f7',
    formula: 'List Ranks (raw) + Realm Stat + List Type + Item + Talent',
    components: [
    ...
    note: 'SCR uses raw rank count and a single realm stat — not the full skill bonus table. Spell succeeds on SCR ≥ 1. The SCR result becomes the target number the defender\'s RR must beat. (SpellLaw Section 4.2; CoreLaw Glossary p.15)',
  },
  {
    key: 'wa',
